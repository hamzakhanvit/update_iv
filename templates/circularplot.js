...
{% comment %}Genes for linear view{% endcomment %}
	{ trackName: "{{ plotName|default:"circular" }}Genes",
	  ...
	  linear_mouseclick: 'islandviewerAlignObj',{% endif %}
	  linear_mouseover: 'islandviewerAlignObj',
	  linear_mouseout: 'islandviewerAlignObj',
	  items: [
		{% for gene in genes %}
...
{% comment %}Islandpick track data{% endcomment %}
	  ...
	  min_slice: true,
	  mouseover_callback: 'islandviewerAlignObj',
	  mouseout_callback: 'islandviewerAlignObj',
	  mouseclick: 'islandviewerAlignObj',
	  {% if ext_id %}ext_id: '{{ext_id}}',
	  linear_mouseclick: 'islandviewerAlignObj',{% endif %}
	  linear_mouseover: 'islandviewerAlignObj',
	  linear_mouseout: 'islandviewerAlignObj',
...
{% comment %}Virulence factor data{% endcomment %}
	...
	{ trackName: "{{ plotName|default:"circular" }}Virulence",
	  ...
	  linear_mouseover: 'islandviewerAlignObj',
	  linear_mouseout: 'islandviewerAlignObj',
          linear_mouseclick: 'islandviewerAlignObj',
	  showTooltip: true,
	  items: [
...
var {{ plotName|default:"circular" }}layout = {genomesize: {{ genomesize }}, container: "{{ container }}", h: 500, w: 500, ExtraWidthX: 55, TranslateX: 25, ExtraWidthY: 40, TranslateY: 20, movecursor: true, dblclick: '{{ varName|default:'' }}islandviewerAlignObj', plotid: 'circularchart|' + shortened_ext_id };
...
//    console.log(second_genomesize);
   ...
   var secondlayout = {genomesize: second_genomesize, container: "#rightplot", h: 500, w: 500, ExtraWidthX: 55, TranslateX: 25, ExtraWidthY: 40, TranslateY: 20, movecursor: true, plotid: 'circularchart', dblclick: 'islandviewerAlignObj' };
